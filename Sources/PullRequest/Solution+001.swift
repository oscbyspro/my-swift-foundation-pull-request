...
words: UnsafeMutableBufferPointer<UInt>, isSigned: Bool) -> ArraySlice<UInt8> {
    ...
    let radix: (exponent: Int, power: UInt) = maxDecimalExponentAndPowerForUnsignedIntegerWord001()
...
/// ```
///
private func maxDecimalExponentAndPowerForUnsignedIntegerWord001() -> (exponent: Int, power: UInt) {
